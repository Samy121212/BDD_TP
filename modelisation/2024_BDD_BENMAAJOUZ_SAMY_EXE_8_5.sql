...
DROP PROCEDURE IF EXISTS ajouter_disponibilite;
DROP PROCEDURE IF EXISTS modifier_disponibilite;
DROP PROCEDURE IF EXISTS supprimer_disponibilite;
...
BEGIN
    ...
    ELSE
        ...
        VALUES (uuid_generate_v4(), p_date_debut, p_date_fin, p_id_materiel);
    END IF;
END;
$$;
